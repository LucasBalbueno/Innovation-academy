...
const CoursesView = () => {
  ...
  const courses = [
    {
      ...
      path: "/home/cursos/html",
    },
    {
      name: "CSS",
      image: LogoCSS,
      description: "Iniciante",
      path: "/home/cursos/css",
    },
    {
      name: "JavaScript",
      image: LogoJS,
      description: "Avançado",
      path: "/home/cursos/javascript",
    },
    {
      name: "React",
      image: LogoReact,
      description: "Iniciante",
      path: "/home/cursos/reactjs",
    },
    {
      name: "NodeJs",
      image: LogoNode,
      description: "Iniciante",
      path: "/home/cursos/nodejs",
    },
    {
      name: "Java",
      image: LogoJava,
      description: "Intermediário",
      path: "/home/cursos/java",
    },
    {
      name: "Python",
      image: LogoPython,
      description: "Iniciante",
      path: "/home/cursos/python",
    },
    {
      name: "SASS",
      image: SASSLogo,
      description: "Intermediário",
      path: "/home/cursos/sass",
    },
  ];
  ...
  const events = [
    {
      name: "Aula sobre IA",
      data: "28 DE AGOSTO - 19 HORAS",
      description: "Iniciante",
      link: "https://www.youtube.com/watch?v=jQMbuK6URws&list=PLHz_AreHm4dm24MhlWJYiR_Rm7TFtvs6S&ab_channel=CursoemV%C3%ADdeo",
    },
    {
      name: "Algoritmos",
      data: "30 DE AGOSTO - 19 HORAS",
      description: "Iniciante",
      link: "https://www.youtube.com/watch?v=JaTf3dhx464&ab_channel=Sharpax",
    },
    {
      name: "React Routers",
      data: "28 DE SETEMBRO - 19 HORAS",
      description: "Avançado",
      link: "https://www.youtube.com/watch?v=7b42lVMdEjE&ab_channel=MatheusBattisti-HoradeCodar",
    },
    {
      name: "Orientação a Objetos",
      data: "28 DE OUTUBRO - 20 HORAS",
      description: "Avançado",
      link: "https://www.youtube.com/watch?v=f-aDDLRmugU&ab_channel=Sharpax",
    },
  ];
  ...
  const recentAccess = [
    {
      ...
      image: LogoJS,
      hours: "60 HORAS",
      lesson: "Aula 8 - Arrow Functions em JS",
      progress: "80%",
    },
    {
      name: "HTML",
      ...
      <div className="container">
        ...
        <div className="container-card">
          {courses.map((course, index) => (
            <Card
              key={index}
              className="card-div d-flex align-items-center justify-content-center text-center"
            ...
            >
              ...
              <CardFooter className="cardFooter-text">{course.name}</CardFooter>
            </Card>
          ))}
        </div>
